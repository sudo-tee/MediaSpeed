...
// Prevent overposting.
const props = ["type", "uid", "library_uid", "filePath", "fileName", "show", "episode_number", "season_number", "name", "tmdb_show_id", "id", "overview", "vote_average", "vote_count", "show_uid", "season_uid"];
